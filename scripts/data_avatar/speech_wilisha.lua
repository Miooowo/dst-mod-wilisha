...
return
{
	ACTIONFAIL =
	{
		...
		GIVE =
		{
			...
			BUSY = "我马上再试试。",		--给予失败，目标正忙
			ABIGAILHEART = "这值得一试。",		--给阿比盖尔告密的心，无效
			GHOSTHEART = "或许，这不是好主意。",		--给鬼魂告密的心，无效
			NOTGEM = "我不会把那东西粘上去的！",		--给的不是宝石
			WRONGGEM = "这个宝石在这里不起作用。",		--给错了宝石
			NOGENERATORSKILL = "我不会把那东西粘上去的！",	--未学习天赋，无法给宝石发电机安装纯粹辉煌和启迪碎片
			NOTSTAFF = "它的形状有些不对。",		--给月石祭坛的物品不是法杖
			MUSHROOMFARM_NEEDSSHROOM = "一颗蘑菇可能会有更多的用处。",		--蘑菇农场需要先种蘑菇
			MUSHROOMFARM_NEEDSLOG = "一块活木头可能会有更多的用处。",		--蘑菇农场需要活木
			MUSHROOMFARM_NOMOONALLOWED = "这些蘑菇好像不愿意被种下去！",		--蘑菇农场无法种月光蘑菇
			...
			TERRARIUM_REFUSE = "也许我应该用不同种类的燃料进行实验……",		--给泰拉瑞亚非噩梦燃料
		...
		HEAL =
		{
			NOT_MERM = "我猜它只对鱼人有效。",	--蚊血注射液只对鱼人有效
		},
		...
		MOUNT =
		{
			TARGETINCOMBAT = "我还没笨到去惹一头狂牛！",		--骑乘失败，牛正在战斗
		...
		PICK =
		{
			NOTHING_INSIDE = "它是空的。",	--水獭掠夺者窝点里没东西
		},
		PICKUP =
		{
		...
		RUMMAGE =	--打开或关闭容器
		{
			...
			INUSE = "他们在垃圾里埋头寻找。",		--不能打开箱子，别人正在使用
			NOTMASTERCHEF = "烹饪水平还不够。",		--使用大厨厨具
			NOTAMERM = "我不认为鱼人会为此感到高兴。",	--非鱼人不能打开鱼人工具棚和军械库
		},
		SADDLE =
		{
	...
	ANNOUNCE_PREFALLINVOID = "我感觉到事态的严重性！",	--吊桥正在裂开，即将塌掉
	...
	ANNOUNCE_WORMS_BOSS = "听起来不太妙？",	--大蠕虫袭击即将到来
	...
	--wormwood specific
	ANNOUNCE_KILLEDPLANT =			--（沃姆伍德杀死植物）
	{
		"对不起，朋友",
        "不喜欢伤害朋友",
        "朋友不喜欢那样",
	},
	ANNOUNCE_GROWPLANT =				--（沃姆伍德种植植物）
	{
		"生长吧！",
        "新朋友！",
        "生日快乐！",
	...
	ANNOUNCE_RABBITKING_AGGRESSIVE = "有些东西正在慢慢掘出表面。",	--召唤出暴戾兔王
	ANNOUNCE_RABBITKING_PASSIVE = "有东西在地下轻轻地蠕动。",	--召唤出和善兔王
	ANNOUNCE_RABBITKING_LUCKY = "这个兔子长得好奇怪！",	--机缘兔子出现
	ANNOUNCE_RABBITKING_LUCKYCAUGHT = "抓到你啦！",	--抓到机缘兔子
	ANNOUNCE_RABBITKINGHORN_BADSPAWNPOINT = "兔子们也许不喜欢这个地方。",	--玩家不在陆地上，无法召唤出便携式巢穴

	-- Hallowed Nights 2024
	ANNOUNCE_NOPUMPKINCARVINGONFIRE = "这南瓜都烤熟了。",	--雕刻时被火烧中断
	...
	DESCRIBE =
	{
		...
		WINONA_SPOTLIGHT =
		{
			...
			SLEEP = "好棒的主意！",	-- 物品名:"薇诺娜的聚光灯"->休眠 制造描述:"白天夜里都发光"
		},
		WINONA_BATTERY_LOW =
		{
		...
		OTTER = "你去找另外一只水獭看看。",	--物品名:"水獭掠夺者"
		OTTERDEN = {
			GENERIC = "除了一个水獭窝，再没什么别的了。",	--物品名:"水獭掠夺者窝点"->默认
			HAS_LOOT = "这我得仔细看看。",	--物品名:"水獭掠夺者窝点"->有物品
		},
		...
		ANCIENTTREE_SEED = "世上没有惊喜，只有不全面的统计。",	--物品名:"惊喜种子"

		ANCIENTTREE_GEM = {
			GENERIC = "蔬菜与矿物质的化合物。奇特啊。",	--物品名:"萌芽石"->默认
		...
		ANCIENTTREE_SAPLING = {
			GENERIC = "它在长大！我觉得？",	--物品名:"年轻萌芽石"->默认
			WRONG_TILE = "这里给不了它所需的营养。",	--物品名:"年轻萌芽石"->地皮错误
			WRONG_SEASON = "它看起来很适合，但还没准备要生长。",	--物品名:"年轻萌芽石"->季节不对
		},
		...
		GELBLOB =
		{
			GENERIC = "”咦~“就对了！",	--物品名:"恶液"->默认
			HAS_ITEM = "哦，我把东西落在这里了。",	--物品名:"恶液"->里面有东西
			HAS_CHARACTER = "有人陷入了困境。",	--物品名:"恶液"->里面有玩家
		},
		RABBITKING_AGGRESSIVE = "它有兔子脾气！",	--物品名:"暴戾兔王"
		RABBITKING_PASSIVE = "为善良欢呼！",	--物品名:"和善兔王"
		RABBITKING_LUCKY = "为了科学得抓住它！",	--物品名:"机缘兔子"
		RABBITKINGMINION_BUNNYMAN = "他们疯了！",	--物品名:"皇家兔子警卫"
		ARMOR_CARROTLURE = "我喜欢紧密团结的盔甲。",	--物品名:"胡萝卜外套" 制造描述:"穿上这件外套，兔人就会跳过来。"
		RABBITKINGHORN = "兔子们喜欢音乐。",	--物品名:"挖洞兔号角" 制造描述:"随时随洞召唤兔子来保管你的东西。"
		RABBITKINGHORN_CHEST = "我会时不时地使用它。",	--物品名:"便携式巢穴"
		RABBITKINGSPEAR = "这会带来很好的冲击力。",	--物品名:"兔王棍"
		RABBITHAT = "这个帽子会把兔子放在你的头上。",	--物品名:"洞穴花环" 制造描述:"从未如此悠闲的抓过兔子。"
		WORM_BOSS = "大虫子！",	--物品名:"巨大洞穴蠕虫"

		STONE_TABLE = -- Shared between the round and square tables.
		{
			GENERIC = "我周期性地使用桌子。",	--物品名:"圆石桌/方石桌"->没东西 制造描述:"圆形石桌，用来放东西。/方形石桌，用来放东西。"
			HAS_ITEM = "我周期性地使用桌子。",	--物品名:"圆石桌/方石桌"->有东西 制造描述:"圆形石桌，用来放东西。/方形石桌，用来放东西。"
		},

		STONE_CHAIR =
		{
			GENERIC = "我想坐在那张...石椅上！",	--物品名:"石椅"->无人 制造描述:"可以坐的石椅。"
			OCCUPIED = "别人在坐着。",	--物品名:"石椅"->有人 制造描述:"可以坐的石椅。"
		},

		CARPENTRY_BLADE_MOONGLASS = "就像我的头脑一样，剃刀般锋利！",	--物品名:"月光玻璃锯片" 制造描述:"当普通刀片无法切割时使用。"

		CHEST_MIMIC_REVEALED = "可怕！太可怕了！",	--物品名:"暴躁箱子"
		...
		SHADOWTHRALL_PARASITE = "它让我的大脑发痒。",	--物品名:"虚空面具"
