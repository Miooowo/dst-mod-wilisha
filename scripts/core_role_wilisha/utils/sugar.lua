...
function tool:checkMODEnabledByFolderName(folder_name)
    if TUNING.MOD_ROLE_WILISHA.MOD_LIST and TUNING.MOD_ROLE_WILISHA.MOD_LIST.map_dirname then
        if TUNING.MOD_ROLE_WILISHA.MOD_LIST.map_dirname[folder_name] then
            return true
        end
    end
    return false
...
function tool:checkMODEnabledByModInfoName(modinfo_name)
    if TUNING.MOD_ROLE_WILISHA.MOD_LIST and TUNING.MOD_ROLE_WILISHA.MOD_LIST.map_modinfoname then
        for _,name in ipairs(TUNING.MOD_ROLE_WILISHA.MOD_LIST.map_modinfoname) do
...
function tool:getModConfigDataFromTUNING(op_suffix)
    return TUNING[string.upper('CONFIG_ROLE_WILISHA'..op_suffix)]
end
...
---@return ent
---@nodiscard
function tool:addEntRefer(owner,field,ent,remove_before_add)
